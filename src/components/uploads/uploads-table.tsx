    ...
    <Table<UploadRow>
      ...
      columns={[
        ...
        },
        {
          title: "Detected type",
          dataIndex: "label",
          render: (label: string | null) => label ?? <Typography.Text type="secondary">—</Typography.Text>,
        },
        {
          title: "Country",
          dataIndex: "country",
          width: 100,
          render: (country: string | null) => (country ? <Tag>{country}</Tag> : "—"),
        },
        {
          title: "Period",
          dataIndex: "period",
        ...
        },
        {
          ...
          dataIndex: "status",
          width: 120,
          render: (status: string) => <Tag color={STATUS_COLOURS[status] ?? "default"}>{status}</Tag>,
        },
        {
          title: "Uploaded",
