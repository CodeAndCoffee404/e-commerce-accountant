CREATE TYPE "public"."membership_role" AS ENUM('owner', 'accountant', 'viewer');--> statement-breakpoint
...
ALTER TABLE "allowed_emails" ADD CONSTRAINT "allowed_emails_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
